...
class AppointmentsApi
{
    ...
    /**
     * Operation getUnconfirmedAppointmentsId
     *
     * Retrieve an unconfirmed appointment.
     *
     * @param  string $unconfirmed_appointment_id The ID of an appointment. (required)
     * @param  string $include Comma separated list of optional data to include in the response. (optional)
     *
     * @throws \Aryeo\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Aryeo\Model\UnconfirmedAppointmentResource|\Aryeo\Model\ApiError403|\Aryeo\Model\ApiError404|\Aryeo\Model\ApiFail422|\Aryeo\Model\ApiError500
     */
    public function getUnconfirmedAppointmentsId($unconfirmed_appointment_id, $include = null)
    {
        list($response) = $this->getUnconfirmedAppointmentsIdWithHttpInfo($unconfirmed_appointment_id, $include);
        return $response;
    }

    /**
     * Operation getUnconfirmedAppointmentsIdWithHttpInfo
     *
     * Retrieve an unconfirmed appointment.
     *
     * @param  string $unconfirmed_appointment_id The ID of an appointment. (required)
     ...
     * @throws \Aryeo\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Aryeo\Model\UnconfirmedAppointmentResource|\Aryeo\Model\ApiError403|\Aryeo\Model\ApiError404|\Aryeo\Model\ApiFail422|\Aryeo\Model\ApiError500, HTTP status code, HTTP response headers (array of strings)
     */
    public function getUnconfirmedAppointmentsIdWithHttpInfo($unconfirmed_appointment_id, $include = null)
    {
        $request = $this->getUnconfirmedAppointmentsIdRequest($unconfirmed_appointment_id, $include);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Aryeo\Model\UnconfirmedAppointmentResource' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Aryeo\Model\UnconfirmedAppointmentResource', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 403:
            ...
            $returnType = '\Aryeo\Model\UnconfirmedAppointmentResource';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
    ...
    /**
     * Operation getUnconfirmedAppointmentsIdAsync
     *
     * Retrieve an unconfirmed appointment.
     *
     * @param  string $unconfirmed_appointment_id The ID of an appointment. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getUnconfirmedAppointmentsIdAsync($unconfirmed_appointment_id, $include = null)
    {
        return $this->getUnconfirmedAppointmentsIdAsyncWithHttpInfo($unconfirmed_appointment_id, $include)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getUnconfirmedAppointmentsIdAsyncWithHttpInfo
     *
     * Retrieve an unconfirmed appointment.
     *
     * @param  string $unconfirmed_appointment_id The ID of an appointment. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getUnconfirmedAppointmentsIdAsyncWithHttpInfo($unconfirmed_appointment_id, $include = null)
    {
        $returnType = '\Aryeo\Model\UnconfirmedAppointmentResource';
        $request = $this->getUnconfirmedAppointmentsIdRequest($unconfirmed_appointment_id, $include);
    ...
    /**
     * Create request for operation 'getUnconfirmedAppointmentsId'
     *
     * @param  string $unconfirmed_appointment_id The ID of an appointment. (required)
     * @param  string $include Comma separated list of optional data to include in the response. (optional)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getUnconfirmedAppointmentsIdRequest($unconfirmed_appointment_id, $include = null)
    {
        // verify the required parameter 'unconfirmed_appointment_id' is set
        if ($unconfirmed_appointment_id === null || (is_array($unconfirmed_appointment_id) && count($unconfirmed_appointment_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $unconfirmed_appointment_id when calling getUnconfirmedAppointmentsId'
            );
        }
        if (strlen($unconfirmed_appointment_id) > 255) {
            throw new \InvalidArgumentException('invalid length for "$unconfirmed_appointment_id" when calling AppointmentsApi.getUnconfirmedAppointmentsId, must be smaller than or equal to 255.');
        }
        if (strlen($unconfirmed_appointment_id) < 0) {
            throw new \InvalidArgumentException('invalid length for "$unconfirmed_appointment_id" when calling AppointmentsApi.getUnconfirmedAppointmentsId, must be bigger than or equal to 0.');
        }

        if ($include !== null && strlen($include) > 255) {
            throw new \InvalidArgumentException('invalid length for "$include" when calling AppointmentsApi.getUnconfirmedAppointmentsId, must be smaller than or equal to 255.');
        }
        if ($include !== null && strlen($include) < 0) {
            throw new \InvalidArgumentException('invalid length for "$include" when calling AppointmentsApi.getUnconfirmedAppointmentsId, must be bigger than or equal to 0.');
        }


        $resourcePath = '/unconfirmed-appointments/{unconfirmed_appointment_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // path params
        if ($unconfirmed_appointment_id !== null) {
            $resourcePath = str_replace(
                '{' . 'unconfirmed_appointment_id' . '}',
                ObjectSerializer::toPathValue($unconfirmed_appointment_id),
                $resourcePath
            );
        }
