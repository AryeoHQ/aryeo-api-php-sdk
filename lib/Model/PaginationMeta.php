...
class PaginationMeta implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets from
     *
     * @param int|null $from The ID of the first record on this page. This is specified as either `integer` or `null` purely for contract testing purposes. The model which is autogenerated from this definition will be thrown out and written by-hand.
     *
     * @return self
     */
     ...
     * Sets to
     *
     * @param int|null $to The ID of the last record on this page. This is specified as either `integer` or `null` purely for contract testing purposes. The model which is autogenerated from this definition will be thrown out and written by-hand.
     *
     * @return self
     */
