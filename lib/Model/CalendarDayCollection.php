...
/**
 * CalendarDayCollection Class Doc Comment
 *
 * @category Class
 ...
 */
class CalendarDayCollection implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CalendarDayCollection';
    ...
    public function setStatus($status)
    {
        if ((mb_strlen($status) > 255)) {
            throw new \InvalidArgumentException('invalid length for $status when calling CalendarDayCollection., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($status) < 0)) {
            throw new \InvalidArgumentException('invalid length for $status when calling CalendarDayCollection., must be bigger than or equal to 0.');
        }
     ...
     * Gets data
     *
     * @return \Aryeo\Model\CalendarDay[]|null
     */
     ...
     * Sets data
     *
     * @param \Aryeo\Model\CalendarDay[]|null $data 
     *
     * @return self
     */
