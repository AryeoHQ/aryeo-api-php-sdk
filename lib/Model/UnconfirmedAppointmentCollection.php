...
/**
 * UnconfirmedAppointmentCollection Class Doc Comment
 *
 * @category Class
 ...
 */
class UnconfirmedAppointmentCollection implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UnconfirmedAppointmentCollection';
    ...
    protected static $openAPITypes = [
        'status' => 'string',
        'data' => '\Aryeo\Model\UnconfirmedAppointment[]',
    ...
    public function setStatus($status)
    {
        if ((mb_strlen($status) > 255)) {
            throw new \InvalidArgumentException('invalid length for $status when calling UnconfirmedAppointmentCollection., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($status) < 0)) {
            throw new \InvalidArgumentException('invalid length for $status when calling UnconfirmedAppointmentCollection., must be bigger than or equal to 0.');
        }
     ...
     * Sets data
     *
     * @param \Aryeo\Model\UnconfirmedAppointment[]|null $data 
     *
     * @return self
     */
