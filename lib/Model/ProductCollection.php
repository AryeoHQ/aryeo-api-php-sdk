...
class ProductCollection implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setStatus($status)
    {
        if ((mb_strlen($status) > 255)) {
            throw new \InvalidArgumentException('invalid length for $status when calling ProductCollection., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($status) < 0)) {
            throw new \InvalidArgumentException('invalid length for $status when calling ProductCollection., must be bigger than or equal to 0.');
        }
     ...
     * Gets data
     *
     * @return \Aryeo\Model\Product[]|null
     */
     ...
     * Sets data
     *
     * @param \Aryeo\Model\Product[]|null $data 
     *
     * @return self
     */
