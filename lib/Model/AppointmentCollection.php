 ...
 */
class AppointmentCollection implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AppointmentCollection';
    ...
    public function setStatus($status)
    {
        if ((mb_strlen($status) > 255)) {
            throw new \InvalidArgumentException('invalid length for $status when calling AppointmentCollection., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($status) < 0)) {
            throw new \InvalidArgumentException('invalid length for $status when calling AppointmentCollection., must be bigger than or equal to 0.');
        }
     ...
     * Sets data
     *
     * @param \Aryeo\Model\Appointment[]|null $data 
     *
     * @return self
     */
