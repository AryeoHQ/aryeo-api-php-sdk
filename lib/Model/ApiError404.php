...
class ApiError404 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setStatus($status)
    {
        if ((mb_strlen($status) > 255)) {
            throw new \InvalidArgumentException('invalid length for $status when calling ApiError404., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($status) < 0)) {
            throw new \InvalidArgumentException('invalid length for $status when calling ApiError404., must be bigger than or equal to 0.');
        }
    ...
    public function setMessage($message)
    {
        if ((mb_strlen($message) > 255)) {
            throw new \InvalidArgumentException('invalid length for $message when calling ApiError404., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($message) < 0)) {
            throw new \InvalidArgumentException('invalid length for $message when calling ApiError404., must be bigger than or equal to 0.');
        }
