...
/**
 * TimeslotCollection Class Doc Comment
 *
 * @category Class
 ...
 */
class TimeslotCollection implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TimeslotCollection';
    ...
    public function setStatus($status)
    {
        if ((mb_strlen($status) > 255)) {
            throw new \InvalidArgumentException('invalid length for $status when calling TimeslotCollection., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($status) < 0)) {
            throw new \InvalidArgumentException('invalid length for $status when calling TimeslotCollection., must be bigger than or equal to 0.');
        }
     ...
     * Gets data
     *
     * @return \Aryeo\Model\Timeslot[]|null
     */
     ...
     * Sets data
     *
     * @param \Aryeo\Model\Timeslot[]|null $data 
     *
     * @return self
     */
