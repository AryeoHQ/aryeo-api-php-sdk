...
/**
 * OrderCollection Class Doc Comment
 *
 * @category Class
 ...
 */
class OrderCollection implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderCollection';
    ...
    public function setStatus($status)
    {
        if ((mb_strlen($status) > 255)) {
            throw new \InvalidArgumentException('invalid length for $status when calling OrderCollection., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($status) < 0)) {
            throw new \InvalidArgumentException('invalid length for $status when calling OrderCollection., must be bigger than or equal to 0.');
        }
     ...
     * Sets data
     *
     * @param \Aryeo\Model\Order[]|null $data 
     *
     * @return self
     */
